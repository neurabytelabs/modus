defmodule ModusWeb.DashboardChartsTest do
  ...
  describe "resource_chart/1" do
    test "renders with resource data" do
      html = render_component(&DashboardCharts.resource_chart/1, %{data: %{wood: 10, stone: 5, food: 8, herbs: 3}})
  ...
  describe "relationship_chart/1" do
    test "renders with nodes and edges" do
      ...
      html = render_component(&DashboardCharts.relationship_chart/1, %{nodes: nodes, edges: edges})
  ...
  describe "ecosystem_chart/1" do
    test "renders donut chart" do
      html = render_component(&DashboardCharts.ecosystem_chart/1, %{predators: 5, prey: 15, agents: 10})
    ...
    test "renders with zeros" do
      html = render_component(&DashboardCharts.ecosystem_chart/1, %{predators: 0, prey: 0, agents: 0})
      assert html =~ "<svg"
    end
  end
end
