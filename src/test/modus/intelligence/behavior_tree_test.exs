defmodule Modus.Intelligence.BehaviorTreeTest do
  ...
  describe "evaluate/2 — need-driven" do
    test "hungry agent seeks food" do
      agent = %{
        Agent.new("Test", {5, 5})
        | needs: %{hunger: 85.0, social: 50.0, rest: 80.0, shelter: 70.0}
      }
    ...
    test "exhausted agent goes to sleep" do
      agent = %{
        Agent.new("Test", {5, 5})
        | needs: %{hunger: 30.0, social: 50.0, rest: 15.0, shelter: 70.0}
      }
    ...
    test "lonely agent seeks friend (critical)" do
      agent = %{
        Agent.new("Test", {5, 5})
        | needs: %{hunger: 30.0, social: 15.0, rest: 80.0, shelter: 70.0}
      }
    ...
    test "hunger takes priority over low social" do
      agent = %{
        Agent.new("Test", {5, 5})
        | needs: %{hunger: 90.0, social: 10.0, rest: 80.0, shelter: 70.0}
      }
