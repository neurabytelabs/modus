defmodule Modus.I18n do
  ...
  @name_pools %{
    ...
    "tr" => [
      "Ayşe", "Mehmet", "Zeynep", "Ali", "Elif", "Emre", "Fatma",
      "Mustafa", "Defne", "Burak", "Yasemin", "Deniz", "Ebru", "Can",
      "Selin", "Baran", "Derya", "Hakan", "Merve", "Kerem", "Gizem",
      "Arda", "Naz", "Oğuz", "Esra", "Kaan", "İrem", "Serhan",
      "Ceren", "Volkan", "Başak", "Emir", "Asya", "Tuna", "Melisa",
      "Onur", "Ece", "Barış", "Pınar", "Tolga", "Leyla", "Mert",
      "Sibel", "Yiğit", "Damla", "Cem", "Nehir", "Alp", "Lale", "Koray"
    ],
    "de" => [
      "Hans", "Greta", "Friedrich", "Anna", "Wilhelm", "Elsa", "Karl",
      "Lena", "Maximilian", "Sophie", "Heinrich", "Marie", "Ludwig", "Clara",
      "Stefan", "Heidi", "Dieter", "Hanna", "Werner", "Liesel", "Otto",
      "Frieda", "Klaus", "Maren", "Rainer", "Ingrid", "Bernd", "Helga",
      "Günther", "Petra", "Horst", "Brigitte", "Volker", "Ursula", "Manfred",
      "Erika", "Dietrich", "Sabine", "Gerhard", "Monika", "Ernst", "Renate",
      "Albert", "Hildegard", "Konrad", "Irmgard", "Walter", "Christa", "Roland", "Gisela"
    ],
    "fr" => [
      "Pierre", "Marie", "Jean", "Claire", "Louis", "Amélie", "François",
      "Sophie", "Antoine", "Juliette", "Mathieu", "Camille", "Nicolas", "Élise",
      "Guillaume", "Margaux", "Étienne", "Chloé", "Henri", "Léa", "Jacques",
      "Manon", "Luc", "Émilie", "Rémy", "Fleur", "Alain", "Noémie",
      "Yves", "Colette", "Marcel", "Isabelle", "Olivier", "Brigitte", "Thierry",
      "Madeleine", "René", "Odette", "Bernard", "Geneviève", "Philippe", "Monique",
      "André", "Simone", "Gaston", "Hélène", "Lucien", "Claudine", "Maurice", "Céleste"
    ],
    "es" => [
      "Carlos", "María", "Pablo", "Lucía", "Miguel", "Ana", "Alejandro",
      "Carmen", "Diego", "Elena", "Javier", "Isabel", "Mateo", "Sofía",
      "Fernando", "Valentina", "Andrés", "Luna", "Rodrigo", "Camila",
      "Sebastián", "Daniela", "Emilio", "Paula", "Rafael", "Mariana",
      "Gabriel", "Jimena", "Tomás", "Catalina", "Santiago", "Alma",
      "Nicolás", "Renata", "Eduardo", "Victoria", "Marcos", "Paloma",
      "Ramón", "Inés", "Martín", "Esperanza", "Hugo", "Rosa",
      "Álvaro", "Pilar", "Iker", "Consuelo", "Adrián", "Dolores"
    ],
    "ja" => [
      "Haruto", "Yui", "Sota", "Hina", "Ren", "Aoi", "Yuto",
      "Sakura", "Minato", "Himari", "Riku", "Mei", "Kaito", "Rin",
      "Asahi", "Yuna", "Sora", "Akari", "Hinata", "Mio", "Yamato",
      "Kokona", "Itsuki", "Hana", "Takumi", "Koharu", "Hayato", "Saki",
      "Kota", "Riko", "Yuki", "Nana", "Ryota", "Miku", "Daichi",
      "Ayaka", "Shun", "Kanna", "Tsubasa", "Miyu", "Naoki", "Shiori",
      "Kenji", "Yuki", "Akira", "Misaki", "Ryo", "Haruka", "Shota", "Nanami"
    ]
  }
  ...
  @season_names %{
    "en" => %{spring: "🌸 Spring has arrived!", summer: "☀️ Summer blazes!", autumn: "🍂 Autumn descends!", winter: "❄️ Winter grips the world!"},
    "tr" => %{spring: "🌸 Bahar geldi!", summer: "☀️ Yaz başladı!", autumn: "🍂 Sonbahar geldi!", winter: "❄️ Kış kapıda!"},
    "de" => %{spring: "🌸 Der Frühling ist da!", summer: "☀️ Sommer ist gekommen!", autumn: "🍂 Der Herbst ist da!", winter: "❄️ Der Winter hat begonnen!"},
    "fr" => %{spring: "🌸 Le printemps est arrivé!", summer: "☀️ L'été brûle!", autumn: "🍂 L'automne descend!", winter: "❄️ L'hiver s'installe!"},
    "es" => %{spring: "🌸 ¡Llegó la primavera!", summer: "☀️ ¡El verano arde!", autumn: "🍂 ¡Llegó el otoño!", winter: "❄️ ¡El invierno llega!"},
  ...
  def language_instruction(lang), do: Map.get(@language_instructions, lang, @language_instructions["en"])
  ...
  def conversation_instruction(lang), do: Map.get(@conversation_instructions, lang, @conversation_instructions["en"])
