defmodule Modus.Simulation.Weather do
  ...
  def biome_weather(biome) do
    ...
    merged =
      Enum.reduce(adjustments, base_weights, fn {k, v}, acc ->
    ...
    new_state =
      cond do
        ...
        state.severe_event != nil and state.severe_ticks > 0 ->
          %{
            state
            | severe_ticks: state.severe_ticks - 1,
              ticks_remaining: new_remaining,
        ...
        state.severe_event != nil and state.severe_ticks <= 0 ->
          ...
          %{
            ...
            | current: next,
              ...
              severe_ticks: 0,
              total_ticks: new_total,
              history: add_history(state.history, next)
          }
            ...
            event ->
              ...
              %{
                ...
                | current: ecfg.base,
                  ...
                  severe_ticks: dur,
                  total_ticks: new_total,
                  history: add_history(state.history, event)
              }
          end
  ...
  defp generate_forecast(current, season, remaining, ticks_ahead, acc) do
    if remaining >= ticks_ahead do
      ...
      next_dur = min_d + div(max_d - min_d, 2)
